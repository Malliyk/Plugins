...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/MoviesHub_Updates_Channel')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/MovieHub_MoviesUpdate"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('➕↖️ Add Me To Your Groups ↗️➕', url=f'https://t.me/+MFSaXSzfx_pkMmI1')
            ],[
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/MovieHub_MoviesUpdate"),
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/MoviesHub_Updates_Channel')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://youtube.com/@mallikarjunayk?si=hriN8_UbcZuBQJoF')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
